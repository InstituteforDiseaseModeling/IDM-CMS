...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "GitHub",
            "url": "https://github.com/institutefordiseasemodeling/IDM-CMS",
...
# of the sidebar.
#
#html_logo = "figures/IDM_white.png"
...
latex_documents = [
    (master_doc, 'idm-cms-docs.tex', u'Compartmental Modeling Software (CMS)',
...
man_pages = [
    (master_doc, 'idm-cms-docs', u'Compartmental Modeling Software(CMS)',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'idm-cms-docs', u'Compartmental Modeling Software (CMS)',
     author, 'Institute for Disease Modeling', 'Compartmental Modeling Software (CMS) from IDM',
     'Miscellaneous'),
]
